<template>
    <div>
        ...
        <div>
            ...
            <div class="headerImg">
                <p class="headerText">课程介绍</p>
            </div>
            <div class="headerImg">
                <p class="headerText">课程大纲</p>
            </div>
        </div>
    </div>
</template>
